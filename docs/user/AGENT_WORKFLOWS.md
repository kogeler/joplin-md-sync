...
These are safe operating procedures. The guarantees behind them are defined by
the [CLI](../contracts/CLI.md),
[workspace](../contracts/WORKSPACE.md), and
[synchronization](../contracts/SYNCHRONIZATION.md) contracts.
